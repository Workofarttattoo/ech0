...
class Ech0TrainingConfig:
    ...
    # Model configuration
    base_model: str = "mistralai/Mistral-7B-Instruct-v0.3"  # Latest Mistral, no token required
    ...
    def from_yaml(cls, config_path: str) -> 'Ech0TrainingConfig':
        ...
        return cls(
            base_model=model_config.get('base_model', 'mistralai/Mistral-7B-Instruct-v0.3'),
